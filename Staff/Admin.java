...
public class Admin extends Staff {
    ...
    public Staff createStaffAccount(String username, String password, LocalDate dateOfBirth, Role role, WorkingHours workingHours) {
        return RestaurantDatabase.createStaffAccount(username, password, dateOfBirth, role, workingHours);
    }

    public Staff createWaiterAccount(String username, String password, LocalDate dateOfBirth, WorkingHours workingHours) {
        return RestaurantDatabase.createStaffAccount(username, password, dateOfBirth, Role.WAITER, workingHours);
    }

    public Staff createAdminAccount(String username, String password, LocalDate dateOfBirth, WorkingHours workingHours) {
        return RestaurantDatabase.createStaffAccount(username, password, dateOfBirth, Role.ADMIN, workingHours);
    }
